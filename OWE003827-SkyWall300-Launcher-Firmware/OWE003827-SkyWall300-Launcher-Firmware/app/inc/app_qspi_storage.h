 ...
 *
 *  @brief		Contains Quad SPI storage definitions. This file is editable.
 *
 */

#ifndef APP_QSPI_STORAGE_H_
#define APP_QSPI_STORAGE_H_

#endif /* APP_QSPI_STORAGE_H_ */