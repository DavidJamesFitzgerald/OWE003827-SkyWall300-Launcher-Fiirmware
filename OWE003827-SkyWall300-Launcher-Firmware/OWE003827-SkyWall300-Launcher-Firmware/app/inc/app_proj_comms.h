 ...
 *
 *  @brief		Contains projectile comms definitions. This file is editable.
 *
 */

#ifndef APP_PROJ_COMMS_H_
#define APP_PROJ_COMMS_H_

#endif /* APP_PROJ_COMMS_H_ */