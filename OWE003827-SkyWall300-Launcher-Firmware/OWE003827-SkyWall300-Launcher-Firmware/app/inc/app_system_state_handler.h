...
/**
 *	@file		app_system_state_handler.h
 *
 ...
 *
 *  @brief		Contains system state definitions. This file is editable.
 *
 */

#ifndef APP_SYSTEM_STATE_HANDLER_H_
#define APP_SYSTEM_STATE_HANDLER_H_

bool app_system_state_init(void);

#endif /* APP_SYSTEM_STATE_HANDLER_H_ */